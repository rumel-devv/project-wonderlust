  ...
  return (
    <div className="min-h-screen bg-[#f8f6f2] flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-xl bg-white rounded-3xl shadow-xl p-8 md:p-12">
        ...
        <div className="my-4">
          <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-2 py-2 bg-black text-white rounded-md cursor-pointer hover:bg-gray-900 transition-all">
            <FaGoogle />
            Sign in with Google
          </button>
        </div>
